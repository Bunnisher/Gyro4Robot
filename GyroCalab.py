...
def gyro_calibration(calibration_time=10):
    ...
    """
    print('--' * 25)
    print('Beginning the calibration YO!  DO NOT move the MPU6050!')
    ...
    while end_loop_time > time.time():
        ...
        if num_of_points % 100 == 0:
            print('Still Calibrating Gyro YO! %d points so far' % num_of_points)
        
    print('Calibration for Gyro is Complete YO!! %d points total' % num_of_points)
